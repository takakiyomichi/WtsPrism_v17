...
using WtsPrism_v17.Services;
using WtsPrism_v17.Views;

namespace WtsPrism_v17
{
    public sealed partial class App : PrismUnityApplication
    {
        ...
        protected override async Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "WtsPrism_v17.ViewModels.{0}ViewModel, WtsPrism_v17", viewType.Name.Substring(0, viewType.Name.Length - 4));
